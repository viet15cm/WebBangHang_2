...
class MyObject {
    ...
    initEvents() {
        ...
        $(".tbData tbody").on("click", "tr", function () {
            ...
            var table = $('#tbKhachHang').DataTable();
    ...
    */
    ...
    loadData() {
        ...
        $.ajax({
            ...
            url: "https://localhost:44399/KhachHangs",
            method: "GET",//put , pop , get,
            contenType: "application/json",

        }).done(function (response) {
            debugger
            $('#tbKhachHang').DataTable().destroy();
            var table = $('#tbKhachHang').DataTable({
        ...
        if (temp.getObjectCode() != null) {
            ...
            $.ajax({
                ...
                if (!res) {
                    ...
                    $("#txtCode").val(res.IDKH);
                    $("#txtName").val(res.TenKH);
